...
def setup_logging():
    ...
    try:
        file_handler = logging.FileHandler(log_file, mode="a", encoding="utf-8")  # Режим дописывания вместо перезаписи
    except PermissionError:
        # Если файл заблокирован, используем временный файл
        temp_file = logs_dir / "utils_temp.log"
        file_handler = logging.FileHandler(temp_file, mode="a", encoding="utf-8")
